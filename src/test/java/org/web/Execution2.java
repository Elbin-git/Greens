...
private void methBTest() {
   System.out.println("E2 Before Test"+System.currentTimeMillis());
}
@AfterTest
private void methATest() {
	System.out.println("E2 After Test"+System.currentTimeMillis());
}
@BeforeClass
private void methBClass() {
	System.out.println("E2 Before class"+System.currentTimeMillis());
	}
@AfterClass
private void methAClass() {
	System.out.println("E2 After class"+System.currentTimeMillis());
}
@BeforeMethod
private void methBMethod() {
	System.out.println("E2 Before Method"+System.currentTimeMillis());
}
@AfterMethod
private void methAMethod() {
	System.out.println("E2 After Method"+System.currentTimeMillis());
}
@Test(priority=-3)
private void meth3() {
